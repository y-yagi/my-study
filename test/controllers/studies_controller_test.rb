...
class StudiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post studies_url, params: { study: { content: @study.content, hour: @study.hour, minute: @study.minute, theme_id: @study.theme_id, title: @study.title, user_id: @study.user_id } }
    end
  ...
  test "should update study" do
    patch study_url(@study), params: { study: { content: @study.content, hour: @study.hour, minute: @study.minute, theme_id: @study.theme_id, title: @study.title, user_id: @study.user_id } }
